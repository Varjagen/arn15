...
# v14.4: the no-FOUC boot whitelist is DERIVED from THEMES, not hand-typed.
# Four themes were missing from it and flashed default dark on every load.
node tools/sync-theme-whitelist.js >/dev/null
